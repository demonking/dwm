...
static const char *fonts[]          = { 
    "xft:Knack Nerd Font:style=Regular:size=10:antialias=true:autohint=true"
};
static const char dmenufont[]       =  "xft:Hack-Regular:style=Regular:size=10";
...
static const char *mutesound[] = { "amixer","-q","-D","pulse","sset","Master","toggle", NULL };
